...
async def interpret_natal_chart(data: dict) -> str:
    ...
    prompt = (
        ...
        "Используй реальные астрологические данные ниже. Не выдумывай положения планет, знаки, ASC и MC.\\n\\n"
        f"{chart_text}\\n\\n"
        "Структура ответа:\\n"
        "<b>Ключ карты</b> — главная энергия личности по Солнцу, Луне и ASC.\\n"
        "<b>Мышление и чувства</b> — Меркурий, Венера, Луна.\\n"
        "<b>Действия и энергия</b> — Марс.\\n"
        "<b>Рост и задачи</b> — Юпитер и Сатурн.\\n"
        "<b>Социальная реализация</b> — MC.\\n"
        "<b>Совет</b> — короткая практичная рекомендация.\\n\\n"
        "Пиши персонально, конкретно и без длинных вступлений."
    )
