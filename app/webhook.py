...
async def yookassa_webhook(request):
    ...
    await send_telegram_message(
        ...
        f"💎 На баланс зачислено: {count} кредит(ов)\n"
        f"🔢 Текущий баланс: {balance} кредит(ов)\n\n"
        f"Спасибо за использование Астронума.\n\n"
        f"✨ Теперь можно выбрать любой астрологический кредит:\n"
        f"• Натальная карта\n"
        f"• Солнечный знак\n"
        f"• Совместимость\n"
        f"• Лунный знак\n"
